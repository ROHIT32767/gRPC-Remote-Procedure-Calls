...
class LoadBalancerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReportLoad = channel.unary_unary(
                '/LoadBalancer/ReportLoad',
                request_serializer=load__balancer__pb2.LoadUpdate.SerializeToString,
                response_deserializer=load__balancer__pb2.RegistrationResponse.FromString,
                _registered_method=True)
...
def add_LoadBalancerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReportLoad': grpc.unary_unary_rpc_method_handler(
                    servicer.ReportLoad,
                    request_deserializer=load__balancer__pb2.LoadUpdate.FromString,
                    response_serializer=load__balancer__pb2.RegistrationResponse.SerializeToString,
            ),
    }
    ...
    server.add_registered_method_handlers('LoadBalancer', rpc_method_handlers)
...
class LoadBalancer(object):
    ...
    def ReportLoad(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/LoadBalancer/ReportLoad',
            load__balancer__pb2.LoadUpdate.SerializeToString,
            load__balancer__pb2.RegistrationResponse.FromString,
            options,
            channel_credentials,
            insecure,
...
def add_ComputeServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'Compute', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('Compute', rpc_method_handlers)
